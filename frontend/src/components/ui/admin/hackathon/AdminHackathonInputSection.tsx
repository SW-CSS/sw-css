...
interface AdminHackathonInputSectionProps {
  icon: IconType;
  label: string;
  tooltip?: string;
...
export default function AdminHackathonInputSection({
  icon: Icon,
  label,
  tooltip,
  inputElement,
}: AdminHackathonInputSectionProps) {
  return (
    <div className="relative flex flex-col gap-2 md:flex-row md:gap-4">
      <p className="peer flex min-w-[120px] cursor-default items-center gap-3 font-bold">
